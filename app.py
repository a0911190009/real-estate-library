      ...
      return '<div class="card hover:border-slate-500 transition cursor-pointer" data-sl-id="' + s.id + '" style="' + cardStyle + '" onclick="slOpenEdit(this.dataset.slId)">'
        + '<div class="flex items-start justify-between">'
          ...
          + '<div class="flex flex-col gap-1 ml-2 flex-shrink-0">'
            ...
            + '</button>'
            + '<button title="在人脈管理查看" data-sl-id="' + s.id + '" style="width:30px;height:30px;border-radius:8px;border:1px solid var(--bd);background:transparent;display:flex;align-items:center;justify-content:center;cursor:pointer;" onclick="event.stopPropagation();window.open(\'https://real-estate-people-334765337861.asia-east1.run.app/people/\' + this.dataset.slId, \'_blank\')">'
